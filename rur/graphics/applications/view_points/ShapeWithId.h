...
struct Shapetraits< Eigen::Vector3d >
{
    ...
    static void update( const Eigen::Vector3d& p, const Eigen::Vector3d& offset, const QColor4ub& color, unsigned int block, Qt3D::VertexBuffer& buffer, boost::optional< comma::Extents< Eigen::Vector3f > >& extents  )
    {
...
struct Shapetraits< comma::Extents< Eigen::Vector3d > >
{
    ...
    static void update( const comma::Extents< Eigen::Vector3d >& e, const Eigen::Vector3d& offset, const QColor4ub& color, unsigned int block, Qt3D::VertexBuffer& buffer, boost::optional< comma::Extents< Eigen::Vector3f > >& extents  )
    {
...
struct Shapetraits< std::pair< Eigen::Vector3d, Eigen::Vector3d > >
{
    ...
    static void update( const std::pair< Eigen::Vector3d, Eigen::Vector3d >& p, const Eigen::Vector3d& offset, const QColor4ub& color, unsigned int block, Qt3D::VertexBuffer& buffer, boost::optional< comma::Extents< Eigen::Vector3f > >& extents  )
    {
...
struct Shapetraits< Ellipse< Size > >
{
    ...
    static void update( const Ellipse< Size >& ellipse, const Eigen::Vector3d& offset, const QColor4ub& color, unsigned int block, Qt3D::VertexBuffer& buffer, boost::optional< comma::Extents< Eigen::Vector3f > >& extents  )
    {
        Eigen::Vector3d c = ellipse.centre - offset;
        const Eigen::Matrix3d& r = RotationMatrix::rotation( ellipse.orientation );
...
template < typename S > struct traits< comma::graphics::View::ShapeWithId< S > >
{
    template < typename Key, class Visitor >
    static void visit( Key, comma::graphics::View::ShapeWithId< S >& p, Visitor& v )
    {
    ...
    template < typename Key, class Visitor >
    static void visit( Key, const comma::graphics::View::ShapeWithId< S >& p, Visitor& v )
    {
        v.apply( "shape", p.shape );
        v.apply( "id", p.id );
        v.apply( "block", p.block );
...
template < std::size_t Size > struct traits< comma::graphics::View::Ellipse< Size > >
{
    template < typename Key, class Visitor >
    static void visit( Key, comma::graphics::View::Ellipse< Size >& p, Visitor& v )
    {
    ...
    template < typename Key, class Visitor >
    static void visit( Key, const comma::graphics::View::Ellipse< Size >& p, Visitor& v )
    {
        v.apply( "centre", p.centre );
        v.apply( "orientation", p.orientation );
        v.apply( "major", p.major );
