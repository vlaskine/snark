...
ModelReader::ModelReader( QGLView& viewer, comma::Csv::Options& options, const std::string& file, bool z_up, comma::graphics::View::coloured* c, const std::string& label )
