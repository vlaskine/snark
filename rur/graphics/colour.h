...
/// visiting traits
template < typename T > struct traits< comma::graphics::colour< T > >
{
    /// const visiting
    template < typename Key, class Visitor >
    static void visit( const Key&, const comma::graphics::colour< T >& p, Visitor& v )
    {
        v.apply( "r", p.red() );
        v.apply( "g", p.green() );
        v.apply( "b", p.blue() );
    ...
    /// visiting
    template < typename Key, class Visitor >
    static void visit( Key, comma::graphics::colour< T >& p, Visitor& v )
    {
        T r = p.red();
        T g = p.green();
        T b = p.blue();
        ...
        v.apply( "b", b );
        v.apply( "a", a );
        p = comma::graphics::colour< T >( r, g, b, a );
    }
};
