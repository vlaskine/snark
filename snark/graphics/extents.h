...
template < typename T > struct traits< snark::graphics::extents< T > >
{
    template < typename Key, class Visitor >
    static void visit( const Key&, const snark::graphics::extents< T >& p, Visitor& v ) // very quick and dirty, very non-generic; need to think how to do it better
    {
    ...
    template < typename Key, class Visitor >
    static void visit( Key, snark::graphics::extents< T >& p, Visitor& v ) // very quick and dirty, very non-generic; need to think how to do it better
    {
        snark::graphics::extents< T > e;
        T t;
        v.apply( "min", t );
        e.add( t );
        v.apply( "max", t );
